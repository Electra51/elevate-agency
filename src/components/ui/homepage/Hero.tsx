  ...
  return (
    ...
    >
      ...
      <div className="mx-auto max-w-7xl h-full px-6 lg:px-12">
        {/* elevate text Logo */}
        <div className="flex flex-col justify-end items-center sm:items-end md:items-end pt-33 sm:pt-27.5 md:pt-32 lg:pt-38.5 pr-0 md:pr-10 lg:pr-27 xl:pr-45 2xl:pr-0">
          <Image
            src="/images/hero-text.svg"
            alt="Elevate"
            width={700}
            height={180}
            className="hero-title w-86 sm:w-125 md:w-138 z-10 lg:w-189.25 object-contain"
            priority
          />
          {/* text and button content */}
          <div className="flex flex-col items-center lg:items-end sm:items-end md:items-end lg:text-right gap-2 mt-7 md:mt-10 lg:mt-12 relative z-10">
        ...
        {/* left statue */}
        <div className="hero-statue absolute z-10 bottom-0 w-78 sm:w-111.75 md:w-109.5 lg:w-136.25 h-65 sm:h-80 lg:h-82.25">
          <Image
