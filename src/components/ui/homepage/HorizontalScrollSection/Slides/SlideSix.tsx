  ...
  return (
    <div className="relative w-screen h-screen flex bg-linear-to-br from-[#370ECD] to-[#370ECD] overflow-hidden">
      ...
      <div className="w-1/2 flex flex-col justify-center 2xl:pl-43.5 xl:pl-34 text-white z-10">
        <h1 className="slide-title text-[64px] font-bold leading-14 -mt-60">
          Analysis & <br /> Scaling
        </h1>
      ...
      <div className="w-1/2 relative">
        ...
        {/* STATUE */}
        <div className="statue-image absolute bottom-0 xl:right-26 xl:bottom-14 2xl:bottom-47 2xl:right-68 z-30 aspect-645/622 w-[min(100%,645px)] max-w-161.25">
          <Image
