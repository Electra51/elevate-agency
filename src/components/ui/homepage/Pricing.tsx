...
export default function Pricing() {
  return (
    <div className="bg-white flex flex-col w-full h-[870px]">
      <div className=" md:max-w-5xl lg:max-w-6xl xl:max-w-7xl items-center justify-between px-8 md:px-20 lg:px-20 xl:px-5 py-4 mx-auto">
        {/* Header */}
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-4 items-end max-w-6xl mx-auto bg-[#F4F3F8] rounded-2xl pb-14">
            {plans.map((plan) =>
              plan.highlight ? (
                ...
                <div
                  key={plan.name}
                  className="text-3xl md:text-[40px] relative rounded-2xl bg-primary text-white px-6 pb-8 mb-0 md:-mb-0 md:translate-y-[-16px] shadow-xl"
                >
                  {/* Badge */}
